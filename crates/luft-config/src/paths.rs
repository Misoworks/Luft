...
impl ConfigPaths {
    pub fn discover() -> Result<Self, ConfigError> {
        ...
        let config_home = xdg_dir("XDG_CONFIG_HOME", &home, ".config").join("luft");
        let state_home = xdg_dir("XDG_STATE_HOME", &home, ".local/state").join("luft");
        let cache_home = xdg_dir("XDG_CACHE_HOME", &home, ".cache").join("luft");
