...
impl Default for SessionDescriptor {
    fn default() -> Self {
        Self {
            ...
            comment: "Staccato Desktop Environment".to_string(),
            exec: "staccato-session --session".to_string(),
            try_exec: default_try_exec(),
            desktop_names: "Staccato".to_string(),
...
mod tests {
    ...
    const INSTALLED_DESKTOP_ENTRY: &str = include_str!("../../../data/sessions/staccato.desktop");
